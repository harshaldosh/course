...
import { ArrowLeft, Play, Clock, DollarSign, Edit, Download, Trash2, Check, ExternalLink, Bot, Award, FileText, BookOpen } from 'lucide-react';
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-2">
              <span className="text-gray-600 text-responsive-sm">Admin Course Details Page</span>
              {course.sponsored && (
